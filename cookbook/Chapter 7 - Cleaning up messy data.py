...
requests = pd.read_csv("/Users/hanxishi/Desktop/D100 FDS/pandas_to_polars_cookbook/data/311-service-requests.csv", dtype="unicode")
requests.head()
...
na_values = ["NO CLUE", "N/A", "0"]
requests_pl = pl.read_csv("/Users/hanxishi/Desktop/D100 FDS/pandas_to_polars_cookbook/data/311-service-requests.csv",
...
na_values = ["NO CLUE", "N/A", "0"]
requests = pd.read_csv("/Users/hanxishi/Desktop/D100 FDS/pandas_to_polars_cookbook/data/311-service-requests.csv", na_values=na_values, dtype={"Incident Zip": str})
...
na_values = ["NO CLUE", "N/A", "0"]
requests_pl = pl.read_csv("/Users/hanxishi/Desktop/D100 FDS/pandas_to_polars_cookbook/data/311-service-requests.csv",null_values=na_values,schema_overrides={"Incident Zip": pl.Utf8})
