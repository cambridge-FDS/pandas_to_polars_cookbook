...
# %%
complaints_pl = pl.read_csv(
    "../data/311-service-requests.csv", schema_overrides={"Incident Zip": pl.Utf8}
)
...
# %%
# TODO: rewrite the above to use the polars library on the polars dataframe complaints_pl
...
# %%
# TODO: rewrite the above to use the polars library
...
# %%
# TODO: rewrite the above to use the polars library. NB: polars' plotting method is sometimes unstable. You might need to use seaborn or matplotlib for plotting.
